...
const steps = [
  {
    ...
    title: "Выбираете",
    description:
      "Просматриваете коллекцию, выбираете понравившиеся вещи. Если нужна помощь с размером или стилем — мы всегда рядом в чате.",
  },
  {
    number: "02",
    title: "Оформляете заказ",
    description:
      "Указываете размер и мерки, если нужно. Мы уточним детали и подтвердим заказ в течение нескольких часов.",
  },
  {
    number: "03",
    title: "Мы создаём",
    description:
      "Ваш заказ шьётся вручную с вниманием к каждому шву. Это занимает от 3 до 14 дней в зависимости от изделия.",
  },
  {
    number: "04",
    title: "Получаете",
    description:
      "Доставляем по России и за рубеж. В посылке — вещь, упакованная с заботой, и маленькая открытка от нас.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Просто
                <span className="italic"> и с любовью</span>
              </h2>
              <p
              ...
              >
                Каждый заказ для нас — это история. Мы не производим вещи потоком — мы создаём их для конкретной женщины, с намерением и уважением.
              </p>
            </div>
          </div>
