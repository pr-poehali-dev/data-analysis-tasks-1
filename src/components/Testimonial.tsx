  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Когда надеваешь вещи Lumière — сразу чувствуешь разницу. Это не просто ткань, это ощущение. Уже третий год возвращаюсь снова и снова.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Екатерина Морозова</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Постоянный клиент, Санкт-Петербург</p>
        </div>
      </div>
    </section>
  )
